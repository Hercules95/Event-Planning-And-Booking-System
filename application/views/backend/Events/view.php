...
<html>
   ...
   <head>
      ...
      <title>View | Event Planning And Booking System</title>
                           ...
                           <table id="example1" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><a href="<?php echo site_url('events/moreDetails')?>/<?php echo $data->eid?>">more details..</a></td>
                                    <td>
                                       <div class="ui buttons">
                                            <a href="<?php echo site_url('events/updateDetails')?>/<?php echo $data->eid?>">
                                          <button class="ui positive button">Update</button></a>
                                          <div class="or"></div>
                                          <a href="<?php echo site_url('events/deleteEvents')?>/<?php echo $data->eid?>"><button class="ui negative button delete">Delete</button></a>
                                       </div>
                                    </td>
                                 </tr>
                                 <?php endforeach?> 
