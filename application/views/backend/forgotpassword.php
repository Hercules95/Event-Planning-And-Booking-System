...
<html>
   ...
   <head>
      ...
      <title>Forgot Password | Event Planning And Booking System</title>
      ...
      <div class="login-box">
         ...
         <div class="card">
            <div class="card-body login-card-body">
               ...
               <form action="<?php echo site_url('forgotPassword/ResetPassword')?>" method="post">
                  <div class="input-group mb-3">
                     <input type="text" class="form-control" id="email" name="email" placeholder="Email" required="">
                  </div>
                  <div class="row">
                     <div class="col-6">
                        <button type="submit" class="btn btn-primary btn-block submitMsg">Submit</button>
                     </div>
                  </div>
