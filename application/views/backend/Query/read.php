                  ...
                  <div class="col-md-12">
                     <div class="card card-primary card-outline">
                        ...
                        <div class="card-body p-0">
                           ...
                           <input type="hidden" name="userId" class="userId" value="<?php echo $msgDetails->userId?>">
                           <input type="hidden" name="queriesId" class="queriesId" value="<?php echo $msgDetails->qid?>">
                        </div>
                        <?php endforeach?>
                        ...
                        <div class="card-footer">
                           <div class="float-right">
                              <button type="button" class="btn btn-default Reply"><i class="fas fa-reply"></i> Reply</button>
                           </div>
                        </div>
                        <!-- /.card-footer -->
                     </div>
